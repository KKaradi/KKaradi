...
Technologies: SystemVerilog, Synopsys DC, Verdi
...
- Created a full-stack language learning solution by integrating Azure speech text services and LLMs to create an immersive custom roleplay site to practice natural conversation in many language

![Language Coach AI Example](LanguageCoachExample.png)

### Cloudy AI Image Editor

- Designed and developed a node based AI art generation frontend with the ability to modify and style images to any
style using Stable Diffusion models, React, Next.js,and Tailwind CSS

![Cloudy AI Image Editor Example](CloudyAIImageEditorExample.png)

### Story AI

- Developed Story AI, an interactive role-playing game inspired by AI Dungeon, utilizing TypeScript and Next.js enhanced with real-time abstract art generation through Stable Diffusion models to visualize story progression

![Story AI Example](StoryAIExample.png) -->

[![Visitor Badge](https://visitor-badge.laobi.icu/badge?page_id=KKaradi.KKaradi)](https://github.com/KKaradi/KKaradi)